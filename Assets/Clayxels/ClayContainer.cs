	...
	public class ClayContainer : MonoBehaviour{
		...
		void Update(){
			if(this.instanceOf != null){
				...
				this.splatRadius = this.instanceOf.splatRadius * ((this.transform.lossyScale.x + this.transform.lossyScale.y + this.transform.lossyScale.z) / 3.0f);
			...
			if(ClayContainer.pickedContainerId > -1){
		  		if(ClayContainer.pickedContainerId != ClayContainer.lastPickedContainerId){
		  			if(ClayContainer.lastPickedContainerId > -1){
		  				...
		  				containers[ClayContainer.lastPickedContainerId].optimizeMemory();
		  			}
		  			...
		  			if(ClayContainer.pickedContainerId > -1){
			  			...
			  			if(container.memoryOptimized){
			  				container.expandMemory();
			  			}
